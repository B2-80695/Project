...
class Employee {
	...
	public double getY_salary() {
		return y_salary;
	}

	public void setY_salary(double y_salary) {
	...
	public void yearlySalary() {
		...
		this.setY_salary(y_salary);
		System.out.println(y_salary);
	}
	
	public void raiseSalary() {
		y_salary = y_salary + (y_salary * 0.1);
		this.setY_salary(y_salary);
		System.out.println(y_salary);
	...
	public String toString() {
		return "First Name = " + fname + ", Last Name = " + lname + ", Salary = " + m_salary;
	}
...
public class Question_2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Yeary Salary: ");
		e1.yearlySalary();
